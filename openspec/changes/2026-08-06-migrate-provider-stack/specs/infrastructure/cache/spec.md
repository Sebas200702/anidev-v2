...
Provides a Redis-compatible caching layer backed by a Redis/mySQL-compatible store such as Dragonfly, exposing typed get, set, delete, TTL, and read-through primitives to domain layers.
